...
NDiplomacy = {
	PRESTIGE_LOSS_ON_SEND_GIFT_DECLINE = 25,
	PIETY_FROM_CHURCH_GIFTS = 3,
	BREAK_TRUCE_PRESTIGE_PERC_COST = 0.65,		-- Percent of current prestige lost before the base prestige cost (below)
	BREAK_TRUCE_PRESTIGE_COST = 200,			-- Base Prestige cost for breaking a truce
	MONTHS_PER_SUCCESSION_CB = 120,				-- Number of months a succession CB lasts
	...
	ATTACKER_CALL_DECLINE_COST = 50, 			-- Prestige cost for refusing to join an offensive war
	DEFENDER_CALL_DECLINE_COST = 150, 			-- Prestige cost for refusing to join a defensive war
	CALL_TO_WAR_DELAY = 90, 					-- Months between attempts to call someone into war
	PAPAL_INVEST_PIETY_COST_MULT = 0.6, 		-- The effect of Papal investiture on the piety cost of the special Papal actions
	SHORT_REIGN_YEARS_END = 5,
	LONG_REIGN_YEARS_START = 15,
	DOW_ON_ALLY_PRESTIGE_COST = 100,
	MINIMUM_SEND_GIFT_COST = 20,
	SEND_GIFT_INCOME_SCALEFACTOR = 24, 
	RELEASE_PRISONER_PIETY = 5,
	USURP_TITLE_PRESTIGE_MULT = 0.33, 			-- Multiplier on Creation Prestige
	...
	DEMESNE_MAX_SIZE_DUKE_MULT = 1.25,			-- Extra Max Demesne Size from the ruler's rank
	DEMESNE_MAX_SIZE_KING_MULT = 2.5,			-- Extra Max Demesne Size from the ruler's rank
	DEMESNE_MAX_SIZE_EMPEROR_MULT = 3.5,		-- Extra Max Demesne Size from the ruler's rank
	DEMESNE_MAX_SIZE_GREAT_DUKE_BONUS = 1.75,	-- Extra Max Demesne Size for Dukes with more than one Duchy
	...
	DEMESNE_MAX_SIZE_PATRICIAN = 1.25,			-- Extra Max Demesne Size for Patricians (Tier effects do no not apply to Patricians!)
	DEMESNE_MAX_SIZE_PATRICIAN_DOGE = 1.5,		-- Extra Max Demesne Size for a Patrician Doge (Tier effects do no not apply to Patricians!)
	GAVELKIND_MAX_SIZE_BONUS = 0.4,			-- Max demesne size bonus from Gavelkind
	...
	MUSLIM_LAW_CHANGE_PIETY_COST = 75,			-- Piety cost for Muslims when changing normal demesne laws
	MUSLIM_CROWN_LAW_CHANGE_PIETY_COST = 100,	-- Piety cost for Muslims when changing Crown laws
	INTER_MUSLIM_WAR_MONTHLY_PIETY_COST = 2.25,  	-- Monthly Piety cost for Muslims who are primary attackers against a ruler of the same religion (not civil wars)
	MUSLIM_TEMPLE_HOLDING_MONTHLY_PIETY = 0.1, 	-- Monthly Piety for Muslims for each Temple holding in the demesne
	DOWRY_MULTIPLIER = 1.5,						-- The Dowry cost for a Patrician is prestige gain from marriage * this
	PRESTIGE_OPINION_DIV = 125,					-- Divider for prestige to vassal opinion (5x higher effect for negative prestige)
	PRESTIGE_OPINION_MAX = 30,					-- Max opinion impact of prestige (positive OR negative)
	PIETY_OPINION_DIV = 35,						-- Divider for piety to church opinion
	PIETY_OPINION_MAX = 25,						-- Max opinion impact of piety (positive OR negative)	
	...
	ASK_FOR_EXCOMMUNICATION_INTERACTION_PIETY = 175,
...
NCharacter = {
	...
	PRESTIGE_FROM_DYNASTY_ON_MARRIAGE_DIV = 25, 	-- Characters get the dynasty prestige of the spouse divided by this on marriage
	NEED_GUARDIAN_AT_AGE = 8, 						-- The age at which children should be appointed a mentor/guardian
	ASSIGN_ACTION_DAYS = 60, 						-- Days before a Councillor can be assigned a new job in a county
	MARRIAGE_TIER_DIFF_PRESTIGE_MULT = 125, 		-- Prestige multiplier from marrying below or above your rank.
	RAISED_TROOPS_VASSAL_OPINION_DAYS = 180,			-- After 73 days of having their troops raised, vassals will get -1 opinion more of you
	...
	MAX_LED_FACTIONS = 3,							-- Maximum number of led Factions
	...
	AGE_OF_ADULTHOOD = 14,							-- Can rule at this age. Also determines when a proper portrait is shown.
	AGE_OF_MARRIAGE_MALE = 14,						-- Male allowed to marry at this age.
	AGE_OF_MARRIAGE_FEMALE = 13,					-- Female allowed to marry at this age.
	MAX_CHILD_BIRTH_AGE = 45,						-- Female menopause age.
	CHILD_BIRTH_TO_PREGNANCY_WAIT = 5,
	BASE_NR_OF_CHILDREN_PER_COUPLE = 2,
	COURT_SIZE_CHILD_PENALTY_THRESHOLD = 30,
	NATURAL_DEATH_CHANCE_AGE_0 = 500,					-- Natural deaths per decade out of 10000 people: Age 0-9
	NATURAL_DEATH_CHANCE_AGE_10 = 25,				-- Natural deaths per decade out of 10000 people: Age 10-19
	NATURAL_DEATH_CHANCE_AGE_20 = 50,				-- Natural deaths per decade out of 10000 people: Age 20-29
	NATURAL_DEATH_CHANCE_AGE_30 = 75,				-- Natural deaths per decade out of 10000 people: Age 30-39
	NATURAL_DEATH_CHANCE_AGE_40 = 100,				-- Natural deaths per decade out of 10000 people: Age 40-49
	NATURAL_DEATH_CHANCE_AGE_50 = 200,				-- Natural deaths per decade out of 10000 people: Age 50-59
	...
	NATURAL_DEATH_CHANCE_AGE_80 = 2500,				-- Natural deaths per decade out of 10000 people: Age 80-90
...
-- Piety from giving titles to the Church or Holy Orders
	BARON_GRANT_TO_CHURCH_PIETY = 50,
	COUNT_GRANT_TO_CHURCH_PIETY = 75,
...
-- Title Destruction Prestige Cost
	...
	EMPEROR_DESTRUCTION_PRESTIGE_COST = 600,
	
-- Title Claiming Prestige Cost
	BARON_CLAIM_PRESTIGE_COST = 150,
	COUNT_CLAIM_PRESTIGE_COST = 250,
	DUKE_CLAIM_PRESTIGE_COST = 500,
...
-- Title Revokation Prestige Cost
	...
	COUNT_REVOKE_PRESTIGE_COST = 75,
	DUKE_REVOKE_PRESTIGE_COST = 150,
	KING_REVOKE_PRESTIGE_COST = 250,
...
-- Title Grant Decadence Reduction (Multiplied with current decadence)
	...
	CLAIM_VASSAL_TITLE_COST_MOD = 1,
	CLAIM_DE_JURE_TITLE_COST_MOD = 0.25,
	NORMAL_LAW_CHANGE_MONTHS = 90,
	...
	EMPIRE_DE_JURE_ASSIMILATION_YEARS = 150,		-- Kingdoms under the de facto control of another empire will change de jure liege after this many years
	...
	TITULAR_TITLE_CREATION_COST_MULT = 1.75,	-- Titular titles are more expensive to create
...
-- Title creation and usurpation requirements	
	...
	EMPIRE_DEJURE_COUNTY_LIMIT_TO_CREATE = 0.6,		-- Fraction of de jure counties that you must control to create an imperial title
	EMPIRE_DEJURE_COUNTY_LIMIT_TO_USURP = 0.75		-- Fraction of de jure counties that you must control to usurp an imperial title	
},

NReligion = {
	AUTHORITY_FROM_CROWN_LOYALIST = -0.01,
	AUTHORITY_FROM_CHURCH_LOYALIST = 0.005,
	CREATE_ANTIPOPE_PRESTIGE_COST = 750,
	CREATE_ANTIPOPE_AUTHORITY_LOSS = 0.2,
	ANTIPOPE_MONTHLY_AUTHORITY_LOSS = 0.0015,
	POPE_DIPLO_TO_AUTHORITY_DIV = 10000,
	EXCOM_MIN_AUTHORITY = 0.2,
	INVASION_MIN_AUTHORITY = 0.3,
	KINGDOM_CREATION_PIETY_COST = 150,
	EMPIRE_CREATION_PIETY_COST = 250,
	CRUSADE_AUTHORITY_COST = 0.05,
	ORTHODOX_PENTARCH_MONTHLY_AUTHORITY = 0.0015
},
...
NEconomy = {
	...
	TRADE_CONNECTED_TO_CAPITAL_BONUS = 0.5,			-- Bonus to trade post income when connected to capital
	TRADE_POST_COST_INC_DIST = 0.005,				-- The % increase in cost due to distance to closest connected province
	TRADE_POST_OPINION_EFFECT = 0.5,				-- The bonus or penalty depending on topliege opinion
	MAX_TRADE_POSTS_BASE = 2,
	MIN_TRADE_POSTS = 5,							-- Minimum number of max trade posts per patrician	
	PATRICIAN_CAMPAIGN_FUND_FACTOR = 100,				-- The effect of money in the Campaign Fund on Doge elections (money * factor)
	PATRICIAN_PRESTIGE_RESPECT_FACTOR = 75,			-- The effect of Prestige on the Respect value for Doge elections (prestige * factor)
	PATRICIAN_AGE_RESPECT_FACTOR = 10,				-- The effect of Age on the Respect value for Doge elections (age * age * factor)
	DOGE_SUCC_RANDOM_FACTOR = 50,					-- The random Respect factor on actual Doge succession
	MERCHANT_REPUBLIC_SALARY_MULT = 5,				-- Councillor salaries in Merchant Republics are multiplied by this
	TRADE_POST_RAISE_LOOT_MULT = 7.5,
	PATRICIAN_FAMILY_SHARES_HEAD = 50,				-- Monthly Patrician Income, number of shares for the Patrician himself
	PATRICIAN_FAMILY_SHARES_REST = 10,				-- Monthly Patrician Income, number of shares for adult male dynasty members in the Patrician's court
	...
	PATRICIAN_GOLD_TO_MONTHLY_PRESTIGE = 0.00075,	-- Prestige that Patricians get each month from their treasury (CFixedPoint64 to support such small numbers)
	PATRICIAN_CITY_TAX_MULT = 0.35,					-- Patricians don't pay normal City Tax to their liege... (CFixedPoint64)
...
NMilitary = {
	...
	TROOP_KILL_FACTOR = 0.05,						-- Affects the death rate in combats(higher gives bigger losses)
	...
	MERCENARY_MAINTENANCE_FACTOR = 4,				-- Maintenance factor for NORMAL mercenary units
	MERCENARY_VASSAL_MAINTENANCE_FACTOR = 0.3,		-- Maintenance factor for VASSALIZED mercenary units
	MERCENARY_HIRE_COST_FACTOR = 0.3,				-- Hire cost factor for mercenary units
	HOLY_ORDER_HIRE_COST_FACTOR = 0.75,				-- Conversion of nominal gold cost to piety cost when hiring Holy Orders
	...
	OPINION_WHEN_MARSHAL_INSTEAD_OF_SELF = 35,		-- Below this opinion value a vassal tends to use his marshal instead of himself when someone asks to raise his troops
	OPINION_WHEN_NO_LEADER = -25,						-- Below this opinion a vassal will not supply a leader for subunits at all
	BATTLE_WARSCORE_WORTH = 300,						-- Warscore from battles are multiplied with this value
	...
	LEVY_PERCENT_BEFORE_CAN_RAISE = 0.35,			-- Needs at least this much % of full levy before we can raise it
	SIEGE_DAMAGE = 0,								-- Siege attack values are multiplied by this value(when not doing a sally)
	PERCENT_OF_GARRISON_DETACHED = 0.05,				-- This percent of the garrison is detached from the winning unit of a siege
	NUM_DAYS_BETWEEN_SIEGE_MORALE_LOSS = 15,		-- Number of days between morale loss for defender in a siege
	SIEGE_MORALE_LOSS = 0.3,						-- Monthly morale loss in a siege
	DAYS_BETWEEN_COMBAT_EVENTS = 10,				-- Combat events will happen every this many days
	BATTLE_PRESTIGE_MULTIPLIER = 25,					-- Total prestige gained in the battle will be this * ( losers losses ) / 1000
	MAINLEADER_PRESTIGE_PART = 0.55,				-- The % of the total prestige gained in the battle that the center flank leader will get
	FLANKLEADER_PRESTIGE_PART = 0.225,				-- The % of the total prestige gained in the battle that each other flank leader will get
	...
	MERC_REINFORCE_RATE_WHEN_IDLE = 0.1,			-- The rate at which mercenaries and holy orders reinforce when not hired
	GARRISON_REINFORCE_RATE_MULTIPLIER = 1,			-- The rate at which the garrison reinforce
	LEVY_RAISED_REINFORCE_RATE_MULTIPLIER = 0.075,	-- The rate at which the garrison/levy reinforce when the levy is raised
	...
	SIEGE_WEALTH_MULTIPLIER = 3,					-- Wealth gain/loss multiplier for sieges
	CAPITAL_WARSCORE_MULTIPLIER = 2.25,				-- Warscore multiplier for capital(this is scaled with SETTLEMENT_WARSCORE_MULTIPLIER)
	SETTLEMENT_WARSCORE_MULTIPLIER = 0.65,			-- Warscore worth for occupied private demesne
	...
	CONTESTED_TITLE_OCCUPIED_WARSCORE_BONUS = 30,	-- Amount of warscore per year since attacker/defender started getting the bonus
	CONTESTED_TITLE_OCCUPIED_WARSCORE_BONUS_INDEP = 45,	-- Amount of warscore per year since attacker/defender started getting the bonus, for independence wars
	REVOLTRISK_REDUCTION_PER_YEAR = 1,
	DIFFERENT_RELIGIONGROUP_SUPPLY_PENALTY = -0.45,	-- Only 75% supply in provinces with different religios group
	MONTHS_UNTIL_REBEL_WIN = 24,					-- Number of days until province is totally conquered by rebels
	OWN_SETTLEMENT_SUPPLY_BONUS = 0.35,				-- Extra supply from being in home realm
	NEUTRAL_SETTLEMENT_SUPPLY_BONUS = -0.1,			-- Neutral supply bonus
	CONTROL_SETTLEMENT_SUPPLY_BONUS = 0.25,			-- Supply bonus from occupied settlements
	ENEMY_SETTLEMENT_SUPPLY_BONUS = -0.15,			-- Supply bonus from enemy settlements(woot!)
	...
	MAX_ATTRITION_LEADER_REDUCTION = -0.25,			-- Center leader reduces max attrition(reduction in actual percent)
	ATTRITION_LEVEL_FACTOR = 0.55,					-- A general "attrition per month" multiplier
	ATTRITION_LEVEL_FACTOR_50_OVER = 1.25,			-- A general "attrition per month" multiplier when 50% over the supply limit
	ATTRITION_LEVEL_FACTOR_100_OVER = 2.25,			-- A general "attrition per month" multiplier when 100% over the supply limit
	COASTAL_SUPPLY_BONUS = 0.4,						-- Supply bonus in coastal provinces
	NAVAL_ATTRITION = 0.1,							-- Attrition taken monthly by units loaded on ships
	ARMY_MOVEMENT_SPEED = 2.5,						-- Base movement speed of land units
	...
	DAYS_BEFORE_DEFENDER_SALLY = 15,					-- Number of days before defenders sally in a siege where they have superior numbers
	TOTAL_OCCUPATION_SCALE = 0.65,					-- The % of occupation which gives you 100% warscore
	...
	FLANKING_DAMAGE_BONUS = 0.5,					-- Percentage bonus when flanking in combat
	LEADER_MARTIAL_DAMAGE_BONUS = 0.25,				-- Percentage bonus to damage for each point of martial the flank leader has
	...
	OCCUPATION_PENALTY_MONTHS_DIFFERENT_RELIGION = 60,
	OCCUPATION_PENALTY_MONTHS_DIFFERENT_RELIGIONGROUP = 120,
	OCCUPATION_PENALTY_MONTHS_DIFFERENT_CULTURE = 60,
	OCCUPATION_PENALTY_MONTHS_DIFFERENT_CULTUREGROUP = 90,

	RETINUE_TECH_INDEX = 6,							-- Recruitment tech index
	RETINUE_HIRE_COST_MULTIPLIER = 0.15,				-- Retinues are free to hire atm, but they cost alot to reinforce
	RETINUE_REINFORCE_RATE = 0.05,
	RETINUE_REINFORCE_COST = 2.5,					-- Retinues cost while reinforcing.
	RETINUE_CONSTANT_COST = 0.15, 					-- Retinues cost at all times.
	MIN_RETINUE = 0,								-- Minimum retinue ( Disabled for now, can be enabled by mods )
	
	TERRAIN_SPEC_BONUS = 0.3,						-- Bonus to fighting in this terrain if you have that terrain as your
	...
	LIEGE_FLEET_SIZE_MULTIPLIER = 0.75,				-- As above but for galleys
	LIEGE_LEVY_COST_MULTIPLIER = 0.65,				-- The vassal will pay regular maintenance * this for the liege levy
	LIEGE_LEVY_SUBUNIT_SIZE_CUTOFF = 2500,			-- The max size of each liege levy subunit.
	...
	COMMAND_MODIFIER_MARTIAL_MULTIPLIER = 0.25,
},

NTechnology = {
	BASE_TECH_GROWTH_CHANCE = 0.02, --Base chance of a progress ( 1/10 of a level ) increase
	BASE_NEIGHBOUR_SPREAD_BONUS = 0.2, --bonus for each neighbour with the tech
	NEIGHBOUR_SAME_RELIGON_GROUP_MULT = 2.25, --multiplier to the above bonus if neighbour is of your religious group
	BASE_DEMESNE_SPREAD_BONUS = 0.35, --bonus for each other province in demesne with the tech
	MAX_DEMESNE_BONUS = 2.0, -- maximum bonus from demesne
	FOCUS_BONUS = 2.5, --bonus for the tech in each group set as the focus
...
NDisease = {
	SMALL_TOWN_INCOME = 13.0, -- A coastal town with this income has no chance of starting an outbreak
	BIG_TOWN_INCOME = 35.0, -- A coastal town with this income is always a canditate for starting an outbreak
...
NAI =
{
	...
	PEACEAI_STALLED_WAR_WARSCORE_MONTHS = 80,				-- Months until total warscore decrease takes full effect(linear)
	PEACEAI_INITIAL_DEFENDER_WARSCORE_RELUCTANCE = -10,		-- Initial defender (warscore) reluctance for accepting whitepeace
	MIL_AI_COUNTER_INVADE_DISTANCE_THRESHOLD = 100,			-- Defenders in wars will not counter invade past this distance
	...
	AI_ASSAULT_RATIO = 7.5									-- AI will launch assaults at this ratio of attackers to defenders
},
